...
$numRows = $this->db->query("SELECT COUNT(*) 
      ...
      'separator' => false
        ...
        $this->data['text_courier_call'] = $this->language->get('text_courier_call');
        $this->data['text_omniva_important'] = $this->language->get('text_omniva_important');
        $this->data['text_latest_courier_call'] = $this->language->get('text_latest_courier_call');
        $this->data['text_eshop_settings'] = $this->language->get('text_eshop_settings');
        $this->data['text_eshop_settings_p'] = $this->language->get('text_eshop_settings_p');
        $this->data['text_omniva_data_send'] = $this->language->get('text_omniva_data_send');
    ...
    public function searchOmnivaOrders()
    {
     ...
     if (!isset($this->request->post['customer']) AND !isset($this->request->post['date_added']) AND !isset($this->request->post['tracking_nr']))
       ...
       if($date != null AND $date != 'undefined' AND $date != '')
        ...
        //return $this->response->setOutput(json_encode($sql));
    ...
    public function callCarrier()
    {
      ...
      <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://service.core.epmx.application.eestipost.ee/xsd">
        ...
        //var_dump($this->getChild('shipping/omnivalt/api_request', $xmlRequest));
